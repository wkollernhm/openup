...
START TRANSACTION;
USE `openup`;
INSERT INTO `tbl_service` (`id`, `url`) VALUES (1, 'http://www.catalogueoflife.org/col/webservice?response=full&format=php&name=');
...
INSERT INTO `tbl_service` (`id`, `url`) VALUES (8, 'http://www.meertens.knaw.nl/pland/rest/?format=php&plantnaam=');

...
/**
 * This is the model class for table "tbl_source_czech_jiri_bezo1".
 *
 * The followings are the available columns in table 'tbl_source_czech_jiri_bezo1':
 * @property string $latin_name
 * @property string $czech_name
 * @property string $first_synonym
 * @property string $second_synonym
 */
class SourceCzechJiriBezo1 extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SourceCzechJiriBezo1 the static model class
	 */
	...
	{
		return 'tbl_source_czech_jiri_bezo1';
	}

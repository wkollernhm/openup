...
<rdf:RDF xmlns="http://www.w3.org/1999/xhtml" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:skos="http://www.w3.org/2004/02/skos/core#">
    ...
    foreach ($entries as $entry) {
        ...
        if ($entry['score'] < 100)
            continue;
        ?>
        <skos:Concept rdf:about="<?php echo xml_encode($baseUrl . '/' . $entry['id']); ?>">
            ...
            ?>
            <skos:editorialNote><?php echo xml_encode($baseUrl . '/references/scientificName/' . $entry['taxon_id']); ?></skos:editorialNote>
            <?php ?>
        </skos:Concept>
        <?php
    }
